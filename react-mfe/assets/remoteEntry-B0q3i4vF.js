const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/localSharedImportMap-6Kt9BnJP.js","assets/preload-helper-C4ldYmuB.js","assets/virtualExposes-Dg1aUkQS.js"])))=>i.map(i=>d[i]);
...
const initResolve = __mfResolveState.initResolve;
  ...
  async function getLocalSharedImportMap() {
    localSharedImportMapPromise ??= __vitePreload(() => import('./localSharedImportMap-6Kt9BnJP.js'),true              ?__vite__mapDeps([0,1]):void 0);
    return localSharedImportMapPromise
  }

  async function getExposesMap() {
    exposesMapPromise ??= __vitePreload(() => import('./virtualExposes-Dg1aUkQS.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.default ?? mod);
