const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/localSharedImportMap-D6gjwAi3.js","assets/preload-helper-C4ldYmuB.js","assets/virtualExposes-CPsNXfjM.js"])))=>i.map(i=>d[i]);
...
const initResolve = __mfResolveState.initResolve;
  ...
  async function getLocalSharedImportMap() {
    localSharedImportMapPromise ??= __vitePreload(() => import('./localSharedImportMap-D6gjwAi3.js'),true              ?__vite__mapDeps([0,1]):void 0);
    return localSharedImportMapPromise
  }

  async function getExposesMap() {
    exposesMapPromise ??= __vitePreload(() => import('./virtualExposes-CPsNXfjM.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.default ?? mod);
