...
const _style_0 = "\n.about[data-v-7a1efb97] {\n  font-family: var(--font-mono, \"DM Mono\", monospace);\n}\n.mfe-badge[data-v-7a1efb97] {\n  display: inline-block;\n  font-size: 0.6rem;\n  letter-spacing: 0.15em;\n  text-transform: uppercase;\n  padding: 0.2rem 0.6rem;\n  border-radius: 999px;\n  border: 1px solid var(--vue, #42b883);\n  color: var(--vue, #42b883);\n  margin-bottom: 1.25rem;\n}\n.about__intro[data-v-7a1efb97] {\n  margin-bottom: 3rem;\n}\n.section-title[data-v-7a1efb97] {\n  font-family: var(--font-display, \"DM Serif Display\", Georgia, serif);\n  font-size: clamp(1.8rem, 4vw, 2.8rem);\n  letter-spacing: -0.03em;\n  color: var(--text, white);\n  margin-bottom: 0.75rem;\n}\n.about__lead[data-v-7a1efb97] {\n  font-size: 0.875rem;\n  line-height: 1.7;\n  color: var(--text, white);\n  max-width: 520px;\n}\n.about__grid[data-v-7a1efb97] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 3rem 4rem;\n}\n.about__col--full[data-v-7a1efb97] {\n  grid-column: 1 / -1;\n}\n.col-heading[data-v-7a1efb97] {\n  font-size: 0.65rem;\n  letter-spacing: 0.2em;\n  text-transform: uppercase;\n  color: var(--text, white);\n  margin-bottom: 1.5rem;\n  padding-bottom: 0.5rem;\n  border-bottom: 1px solid var(--border, #222228);\n}\n\n/* ── Skill filter tabs ── */\n.skill-tabs[data-v-7a1efb97] {\n  display: flex;\n  gap: 0.35rem;\n  margin-bottom: 1.25rem;\n  flex-wrap: wrap;\n}\n.tab-btn[data-v-7a1efb97] {\n  font-family: inherit;\n  font-size: 0.65rem;\n  letter-spacing: 0.1em;\n  text-transform: uppercase;\n  padding: 0.25rem 0.65rem;\n  border-radius: 999px;\n  border: 1px solid var(--border, #2a2a30);\n  background: transparent;\n  color: var(--text, white);\n  cursor: pointer;\n  transition:\n    border-color 150ms ease,\n    color 150ms ease,\n    background 150ms ease;\n}\n.tab-btn[data-v-7a1efb97]:hover {\n  border-color: var(--vue, #42b883);\n  color: var(--vue, #42b883);\n}\n.tab-btn--active[data-v-7a1efb97] {\n  border-color: var(--vue, #42b883);\n  color: var(--vue, #42b883);\n  background: rgba(66, 184, 131, 0.08);\n}\n\n/* ── Skills ── */\n.skill-list[data-v-7a1efb97] {\n  list-style: none;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 0.85rem;\n}\n.skill-item[data-v-7a1efb97] {\n  display: grid;\n  grid-template-columns: 130px 1fr;\n  align-items: center;\n  gap: 1rem;\n  font-size: 0.75rem;\n  color: var(--text, white);\n}\n.skill-item__bar[data-v-7a1efb97] {\n  display: block;\n  height: 2px;\n  background: var(--border, #222228);\n  border-radius: 999px;\n  position: relative;\n  overflow: hidden;\n}\n.skill-item__bar[data-v-7a1efb97]::after {\n  content: \"\";\n  position: absolute;\n  inset: 0;\n  width: var(--w, 0%);\n  background: var(--vue, #42b883);\n  border-radius: 999px;\n  animation: barGrow-7a1efb97 0.8s cubic-bezier(0.4, 0, 0.2, 1) both;\n}\n@keyframes barGrow-7a1efb97 {\nfrom {\n    width: 0;\n}\nto {\n    width: var(--w);\n}\n}\n\n/* ── TransitionGroup: .skill-enter/leave classes ── */\n.skill-list[data-v-7a1efb97] {\n  position: relative; /* anchor for leave-active absolute positioning */\n}\n.skill-enter-active[data-v-7a1efb97],\n.skill-leave-active[data-v-7a1efb97] {\n  transition:\n    opacity 0.25s ease,\n    transform 0.25s ease;\n}\n\n/* Item that is leaving is taken out of flow so others can FLIP into place */\n.skill-leave-active[data-v-7a1efb97] {\n  position: absolute;\n  width: 100%;\n}\n.skill-enter-from[data-v-7a1efb97] {\n  opacity: 0;\n  transform: translateX(-10px);\n}\n.skill-leave-to[data-v-7a1efb97] {\n  opacity: 0;\n  transform: translateX(10px);\n}\n\n/* ── Timeline ── */\n.timeline[data-v-7a1efb97] {\n  list-style: none;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 0;\n}\n.timeline__item[data-v-7a1efb97] {\n  display: grid;\n  grid-template-columns: 72px 1fr;\n  grid-template-rows: auto auto;\n  column-gap: 1rem;\n  padding: 0.9rem 0;\n  border-bottom: 1px solid var(--surface, #1a1a1f);\n  font-size: 0.75rem;\n}\n.timeline__period[data-v-7a1efb97] {\n  grid-row: 1 / 3;\n  color: var(--muted, #6b93b5);\n  font-size: 0.65rem;\n  padding-top: 2px;\n  letter-spacing: 0.05em;\n}\n.timeline__role[data-v-7a1efb97] {\n  color: var(--text, white);\n}\n.timeline__company[data-v-7a1efb97] {\n  color: var(--muted, #6b93b5);\n  font-size: 0.7rem;\n  margin-top: 2px;\n}\n\n/* ── Values ── */\n.values-list[data-v-7a1efb97] {\n  list-style: none;\n  padding: 0;\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(240px, 1fr));\n  gap: 1px;\n  border: 1px solid var(--border, #222228);\n}\n.value-card[data-v-7a1efb97] {\n  background: var(--vue);\n  padding: 1.5rem;\n  display: flex;\n  gap: 1rem;\n  align-items: flex-start;\n  transition: background 200ms ease;\n}\n.value-card[data-v-7a1efb97]:hover {\n  background: var(--bg, #0b1e2d);\n}\n.value-card__icon[data-v-7a1efb97] {\n  font-size: 1.2rem;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.value-card__label[data-v-7a1efb97] {\n  display: block;\n  font-size: 0.8rem;\n  color: var(--text, white);\n  margin-bottom: 0.4rem;\n  font-weight: 500;\n}\n.value-card__desc[data-v-7a1efb97] {\n  font-size: 0.75rem;\n  line-height: 1.6;\n  color: var(--text, white);\n}\n.sr-only[data-v-7a1efb97] {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  padding: 0;\n  margin: -1px;\n  overflow: hidden;\n  clip: rect(0, 0, 0, 0);\n  white-space: nowrap;\n  border: 0;\n}\n@media (max-width: 600px) {\n.about__grid[data-v-7a1efb97] {\n    grid-template-columns: 1fr;\n}\n.about__col--full[data-v-7a1efb97] {\n    grid-column: 1;\n}\n}\n";
...
const AboutPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__scopeId", "data-v-7a1efb97"]]);
